...
* If you are still off from your target frame, check to see how many frames you are off from your target frame. Then add/subtract that amount from the delay of an index on your next attempt. (Multiple test to figure out how many frames you are off may apply)
